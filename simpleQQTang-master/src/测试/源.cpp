...
int main()
{
	...
	int width1, height1;
	unsigned char* image1 = SOIL_load_image("閿熸枻鎷疯耽.jpg", &width1, &height1, 0, SOIL_LOAD_RGB);
	...
	// Load image, create texture and generate mipmaps
	int width2, height2;
	unsigned char* image2 = SOIL_load_image("閿熸枻鎷疯耽.jpg", &width2, &height2, 0, SOIL_LOAD_RGB);
	...
	// Load image, create texture and generate mipmaps
	int width, height;
	unsigned char* image = SOIL_load_image("閿熸枻鎷峰閿熷壙绛规嫹.jpg", &width, &height, 0, SOIL_LOAD_RGB);
	...
	// Load image, create texture and generate mipmaps
	int width7, height7;
	unsigned char* image7 = SOIL_load_image("閿熸枻鎷烽敓鏂ゆ嫹.jpg", &width7, &height7, 0, SOIL_LOAD_RGB);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width7, height7, 0, GL_RGB, GL_UNSIGNED_BYTE, image7);
	glGenerateMipmap(GL_TEXTURE_2D);
	SOIL_free_image_data(image7);
	glBindTexture(GL_TEXTURE_2D, 0);

	Shader ourShader2("myshader3.vs", "myshader3.frag");     //閿熸枻鎷蜂竴閿熻娇鍖℃嫹閿熸枻鎷烽敓鏂ゆ嫹閿熺煫鍖℃嫹鍒犲幓閿熸枻鎷烽敓鏂ゆ嫹鍒犲幓閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹钖归敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹bug
